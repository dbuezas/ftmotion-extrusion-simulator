export function poly6Profile(distance, rate, acceleration, accOvershoot, dt) {
    const profile = [];
    ...
    let acc_c3 = 0.0, acc_c4 = 0.0, acc_c5 = 0.0, acc_c6 = 0.0;
    {
        ...
        // a5_mid = s5''(0.5)/Ts^2
        const a5_mid = s5pp_u(acc_c3, acc_c4, acc_c5, 0.5) / (Ts * Ts);
    ...
    let dec_c3 = 0.0, dec_c4 = 0.0, dec_c5 = 0.0, dec_c6 = 0.0;
    {
        ...
        const a5_mid = s5pp_u(dec_c3, dec_c4, dec_c5, 0.5) / (Ts * Ts);
        const a_mid_target = -accOvershoot * acceleration;
